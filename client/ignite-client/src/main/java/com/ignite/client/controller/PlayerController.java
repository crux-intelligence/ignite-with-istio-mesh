package com.ignite.client.controller;

import com.ignite.client.model.Player;
import com.ignite.client.service.PlayerService;
...
public class PlayerController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public List<Player> fuzzySearchPlayerOnField(
          @PathVariable("text") String text, @PathVariable("fieldName") String fieldName) {
