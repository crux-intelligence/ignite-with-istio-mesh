...
import com.ignite.client.constants.IgniteConstant;
...
@Configuration(IgniteConstant.IGNITE_SYSTEM_PROPERTIES_CONFIGURATION)
      ...
      if (systemProperties != null) {
        systemProperties
            ...
            .forEach(
                e -> {
                  log.info(
                      "Setting up Ignite system properties Name:={} value:={}",
                      e.getKey(),
                      e.getValue());
                });
      }
