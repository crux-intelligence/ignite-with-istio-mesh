...
It also contains a sample Ignite client which can connect to the cluster and perform sample cache operations.
...
```
cd existing_repo
git remote add origin https://gitlab.com/engineering-learning/ignite-with-istio.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/engineering-learning/ignite-with-istio/-/settings/integrations)
...
- [ ] [Analyze your code for known vulnerabilities with Static com.ignite.client.Application Security Testing(SAST)](https://docs.gitlab.com/ee/user/application_security/sast/)
